...
import inhouse.movein.Fragment.FlatSearchTabFragment;
...
public class MainActivity extends BaseActivity
    ...
    private void startFlatSearchFragment() {
        mFragmentManager = getSupportFragmentManager();
        mFragmentTransaction = mFragmentManager.beginTransaction();
        mFragmentTransaction.replace(R.id.containerView, new FlatSearchTabFragment()).commit();
    }
